...
static void        wait_for_state(spi_parms_t *spi_parms, CC11xx_state_t state, uint32_t timeout);
...
static void        radio_init_rx(spi_parms_t *spi_parms, radio_parms_t * radio_parms);

static void        radio_flush_fifos(spi_parms_t *spi_parms);

static int         radio_set_packet_length(spi_parms_t *spi_parms, uint8_t pkt_len);

static uint8_t     radio_get_packet_length(spi_parms_t *spi_parms);
static float       radio_get_rate(radio_parms_t *radio_parms);
